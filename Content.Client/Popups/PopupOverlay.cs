...
public sealed class PopupOverlay : Overlay
{
        ...
        PopupSystem popup)
    {
        ...
        _smallFont = new VectorFont(cache.GetResource<FontResource>("/Fonts/_ArcheCrawl/Lora/Lora-Italic.ttf"), 10);
        _mediumFont = new VectorFont(cache.GetResource<FontResource>("/Fonts/_ArcheCrawl/Lora/Lora-Italic.ttf"), 12);
        _largeFont = new VectorFont(cache.GetResource<FontResource>("/Fonts/_ArcheCrawl/Lora/Lora-BoldItalic.ttf"), 14);
    }
