...
// The reason this is on the server is because it will throw errors onto the client otherwise (or as I like to call it, THE CLIENT IS FUCKING SCREAMING)
...
namespace Content.Server._ArcheCrawl.StatEffects.Effects
{
    public sealed class EffectsSystem : EntitySystem
    {
        ...
        [Dependency] private readonly SharedStatEffectsSystem _statEffects = default!;
        ...
        private void AdjustStrengthEffect(EntityUid uid, AdjustEffectStrengthEffectComponent comp, StatEffectActivateEvent args)
        {
            ...
            _statEffects.ModifyEffect(uid, newStrength, overrideEffect: true, comp: effectComp);
        }
